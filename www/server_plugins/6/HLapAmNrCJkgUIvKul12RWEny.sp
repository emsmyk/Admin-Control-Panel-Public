...
public void OnPluginStart()
{
	...
	//Reg Cmds
	RegAdminCmd("sm_reloadtags", Cmd_ReloadTags, ADMFLAG_ROOT, "Reload HexTags plugin config");
	RegAdminCmd("sm_toggletags", Cmd_ToggleTags, ADMFLAG_ROOT, "Toggle the visibility of your tags");
	RegAdminCmd("sm_tagslist", Cmd_TagsList, ADMFLAG_KICK, "Select your tag!");
